...
import type { useZphNodes } from "./useZphNodes";

type NodesApi = ReturnType<typeof useZphNodes>;

export function ZephyrNodesView({
  nodes,
  onBack,
}: {
  nodes: NodesApi;
  ...
  return (
    <div className="settings-view">
      <div className="mining-header">
        ...
        <h2><ST delay={0} speed={22}>ZEPHYR NODES</ST></h2>
      </div>

      <Card>
        <p className="hint">
          Zephyr mainnet remote-node pool. The pool is hand-curated (no
          Feather-equivalent runtime directory). Default port is 17767.
                ...
                return (
                  <tr
                    ...
                    style={{
                      ...
                      background: isPinned ? "rgba(58,176,255,0.08)" : undefined,
                    }}
                  >
      ...
      <Card title="CUSTOM NODE">
        <p className="hint">
          Have your own Zephyr node, or want to use one not in the trusted list?
          Paste its full URL (e.g. <code>http://my-node.example:17767</code>).
